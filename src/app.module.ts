...
@Module({
    imports: [
        // Límite general de peticiones por IP (defensa contra fuerza bruta y
        // abuso automatizado). Endpoints puntuales pueden pedir uno más
        // estricto con @Throttle(...) (ver AuthController.login).
