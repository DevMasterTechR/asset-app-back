...
export class CreateAssetDto {
  ...
  @ApiPropertyOptional({ enum: AssetStatus, description: 'Estado del activo', example: AssetStatus.available })
  @IsOptional()
  @IsEnum(AssetStatus)
  status?: AssetStatus;
  ...
  @ApiPropertyOptional({ description: 'Atributos adicionales en formato JSON', type: Object, example: { color: 'red', warranty: '2 years' } })
  @IsOptional()
  attributesJson?: any; // manejar validación JSON en servicio si es necesario
}
